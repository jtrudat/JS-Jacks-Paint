function configureListeners() {
    ...
    // images.forEach(document.getElementById(images.id).addEventListener('mouseover', addOpacity, false))
    // images.forEach(document.getElementById(images.id).addEventListener('mouseout', removeOpacity, false))
}
